...
export function ContactSection() {
  ...
  return (
    <Section id="contact" className="border-b-0 pb-8">
      <Reveal>
        <SectionTitle eyebrow="Contacts" title="Контакты" />
      </Reveal>
        ...
        <Card className="overflow-hidden">
          <div className="grid gap-0 lg:grid-cols-[1fr_1.1fr]">
            <div className="border-b border-slate-800/80 p-6 lg:border-b-0 lg:border-r">
              <p className="text-2xl font-black text-white">Готов обсудить frontend-задачи</p>
            ...
            <div className="grid gap-3 p-6 sm:grid-cols-2">
              ...
              <ContactLink icon={MapPin} label="Location" value={profile.location} href="#" />
            </div>
          </div>
        </Card>
      </Reveal>
      ...
      <footer className="mt-8 flex flex-col items-center justify-between gap-3 text-xs text-slate-600 sm:flex-row">
        <span>© 2026 Alex Chub - Frontend Developer</span>
        <span>React / TypeScript / Product Interfaces</span>
      </footer>
    </Section>
  );
}
